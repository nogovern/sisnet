...
$(document).ready(function(){
  ...
  $("#btn_excel_upload").click(function(){
    ...
    $("#modal_container .modal-body").html('<iframe width="100%" height="100%" frameborder="0" scrolling="no" allowtransparency="true" src="'+url+'" name="iframe"></iframe>');
    // $("#modal_container .modal-body").load(url);
