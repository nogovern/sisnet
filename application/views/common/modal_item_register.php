...
?>
<!-- modal dialog -->
<div class="modal fade" id="modal_item_register" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-3" style="padding-left:0;">
              <button id="btn_retrieve_serial" type="button" class="btn btn-info btn-warning">검색</button>
            </div>
          </div>

<!--           <div class="form-group">
            <label class="form-label col-sm-4">직전위치</label>
            <div class="col-sm-5">
              <input type="text" class="form-control" id="prev_location">
            </div>
            <div class="col-sm-3" style="padding-left:0;">
              <button id="btn_retrieve_previous" type="button" class="btn btn-info btn-warning">검색</button>
            </div>
          </div>
 -->
          <div class="form-group">
...
$(document).ready(function(){
  // 모달 보이기 전 설정
  $("#modal_item_register").on('shown.bs.modal', function() {
    $("#serial_number").focus();    // 기본 포커스
    reset_register_form();               // 폼 초기화
  });

  // need for refactoring!!! - 업무 type 으로 업무 model 에서 리스트 갸져오면 됨
  ...
  // 시리얼넘버 검색
  //////////////
  $("#btn_retrieve_serial").on('click', function(e){
...
function changeFormLayout(part_type) {
  var form = $("#modal_item_register form");
