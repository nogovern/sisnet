<?php
// modal_part_register2
// 
// 장비 등록 공통 인터페이스
?>
<!-- modal dialog -->
<div class="modal fade" id="modal_add_op_item" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
$(document).ready(function(){
  // 모달 보이기 전 설정
  $("#modal_add_op_item").on('shown.bs.modal', function() {
...
function changeFormLayout(part_type) {
  var form = $("#modal_add_op_item form");
